...
@section('content')
	...
	<div id="tab-selectors-panel">
		...
		<button class="tab-selector" id="tab_selector_editEvent">Edit Event</button>
		<button class="tab-selector" id="tab_selector_seeEventStats">See Event Stats</button>
		<button class="tab-selector" id="tab_selector_moderateContent">Moderate Content</button>
		
		<!--
		<a class="tab-selector" id="tab_selector_editEvent" href="#"
			onclick="
		...
		<a class="tab-selector" id="tab_selector_seeEventStats" href="#"
			onclick="
	...
	<div id="tab-seeEventStats">

		<p>See Event Stats</p>

	</div>

	<div id="tab-moderateContent">
